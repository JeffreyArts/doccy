...
<form action="/ajax/add_element.php" method="post" class="form-horizontal">
    <fieldset>

        <legend>Element toevoegen</legend>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-9">
                <input name="name" class="form-control" placeholder="Titel">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-9">
                <textarea name="description" class="form-control" placeholder="Omschrijving element"></textarea>
            </div>
        </div>
        ...
        <div class="col-lg-12 pull-right">
            ...
            <div class="panel panel-success hidden" id="functie_eigenschappen">
                <div class="panel-heading">Functie eigenschappen</div>

                <div class="panel-body">
                    <div class="parameters">
                        <div class="input-fields">
                            <?php include($_SERVER['DOCUMENT_ROOT'].'/page/form_element/parameter.php');?>
                        </div>
                    ...
                    <div class="return">
                        <div class="input-fields">
                            <?php include($_SERVER['DOCUMENT_ROOT'].'/page/form_element/return.php');?>
                        </div>
                        <div class="add-input col-lg-10 pull-right">
        ...
        <div class="form-group">
            <div class="col-lg-9">
                <input type="hidden" name="form_type" value="add_element" />
                <input class="btn btn-primary" type="submit" name="add_element" value="Voeg toe">
            </div>
        </div>
